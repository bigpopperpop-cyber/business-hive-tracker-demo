...
type Tab = 'log' | 'history' | 'demo' | 'sync' | 'about';
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col transition-colors duration-300">
        ...
        <div className="max-w-6xl mx-auto px-4 w-full flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            <nav className="hidden lg:flex items-center space-x-1">
              {['log', 'history', 'demo', 'sync', 'about'].map((tab) => (
                <button 
                  key={tab}
                ...
                >
                  {tab === 'log' ? 'Symptom Entry' : tab === 'history' ? 'Patient Stats' : tab === 'demo' ? 'Clinical Demo' : tab}
                </button>
              ))}
            </nav>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 h-16 flex items-center justify-around z-50 no-print shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
        {[
          ...
          { id: 'history', label: 'Stats', icon: <path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /> },
          { id: 'demo', label: 'Demo', icon: <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /> },
